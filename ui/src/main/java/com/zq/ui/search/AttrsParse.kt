...
internal object AttrsParse {
    fun parseSearchViewAttrs(
        ...
        //搜索背景
        val searchBackground = array.getDrawable(R.styleable.SearchView_search_background)
            ?: HiRes.getDrawable(R.drawable.shape_search_view)
        //搜索图标
        val searchIcon = array.getString(R.styleable.SearchView_search_icon)
        ...
        val iconPadding = array.getDimensionPixelOffset(
            R.styleable.SearchView_icon_padding,
            DisplayUtil.sp2px(4f)
        )

        //清除按钮
        val clearIcon = array.getString(R.styleable.SearchView_clear_icon)
        ...
        //提示语
        val hintText = array.getString(R.styleable.SearchView_hint_text)
        ...
        //相对位置
        val gravity = array.getInteger(R.styleable.SearchView_hint_gravity, 1)
        ...
        val keywordColor = array.getColor(R.styleable.SearchView_key_word_color, Color.WHITE)
        val keywordMaxLen = array.getInteger(R.styleable.SearchView_key_word_max_length, 10)
        val keywordBackground = array.getDrawable(R.styleable.SearchView_key_word_background)

        //关键词清除图标
        val keywordClearIcon = array.getString(R.styleable.SearchView_clear_icon)
