...
object PhotoViewer {
    ...
    val fragments = mutableListOf<PhotoViewerFragment>() //fragment 列表
     ...
     * 下标1的为已经被选中的
     */
    private val mDot = intArrayOf(R.drawable.shape_point_normal, R.drawable.shape_point_select)
    ...
    private fun show(activity: AppCompatActivity) {
        ...
        val alphaOa = ObjectAnimator.ofFloat(null, View.ALPHA, 0f, 1f)
        alphaOa.duration = 50
        ...
        val photoViewLayout =
            LayoutInflater.from(activity).inflate(R.layout.fragment_photoviewer, null)
        val viewPager =
            photoViewLayout.findViewById<ViewPager>(R.id.mLookPicVP)
        ...
        frameLayout.post {
            ...
            if (imgData.size in 2..9 && indicatorType == INDICATOR_TYPE_DOT) {
                 ...
                 * 未选中小圆点的间距
                 */
                dotParams.rightMargin = DisplayUtil.dp2px(12f)
                ...
                params.bottomMargin = DisplayUtil.dp2px(70f)
                /**
                 * 首先添加小圆点的Group
                 */
                ...
                params.bottomMargin = DisplayUtil.dp2px(80f)
                frameLayout.addView(mFrameLayout, params)
