...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpacesItemDecoration setParam(int dividerColor, float dividerSpacing) {
     ...
     *                             如果是纵向 - 下边距
     */
    public SpacesItemDecoration setParam(int dividerColor, float dividerSpacing, float leftTopPaddingDp, float rightBottomPaddingDp) {
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setColor(dividerColor);
        mDividerSpacing = dip2px(dividerSpacing);
